...
When you create an adapter don't forget to set **`contextIds`** in `/adapter/dapplet.json`. In this example we are setting the following contexts. On these sites, the adapter will wor:
