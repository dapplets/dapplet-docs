    ...
    <nav ref={navbarRef} className={clsx('navbar', 'navbar--fixed-top', {
      ...
      <div className="navbar__inner">
        ...
        <div className="navbar__items navbar__items--right">
          {rightItems.map((item, i) => <NavbarItem {...item} key={i} onMouseOver={onMouseOver} onMouseOut={onMouseOut} />)}
      ...
      <div className="header-custom-nav">
        <ul className="header__nav-list">
          <li className="header__nav-item">
            <a href="https://dapplets.org/under-construction.html" className="header__nav-link" target="_blank">Store</a>
          </li>
          <li className="header__nav-item">
            <a href="https://dapplets.org/developers.html" className="header__nav-link" target="_blank">Developers</a>
          </li>
          <li className="header__nav-item">
            <a href="https://dapplets.org/join-us.html" className="header__nav-link" target="_blank">Join Us</a>
          </li>
          <li className="header__nav-item">
            <a href="https://blog.dapplets.org/" className="header__nav-link" target="_blank">Blog</a>
          </li>
          <li className="header__nav-item">
            <a href="https://dapplets.org/about.html" className="header__nav-link" target="_blank">About</a>
          </li>
        </ul>
      </div>
      {/* CUSTOM END */}
